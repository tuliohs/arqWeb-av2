...
router.patch('/:id', getAluno, async (req, res) => {
    if (req.body.id != null) { res.aluno.id = req.body.id }
    if (req.body.matricula != null) { res.aluno.matricula = req.body.matricula }
    if (req.body.anoSemestreDeEntrada != null) { res.aluno.anoSemestreDeEntrada = req.body.anoSemestreDeEntrada }
    if (req.body.nomeCompleto != null) { res.aluno.nomeCompleto = req.body.nomeCompleto }
    if (req.body.curso != null) { res.aluno.curso = req.body.curso }
